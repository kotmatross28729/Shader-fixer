...
public enum EarlyMixins implements IMixins {
    ...
    VANILLA_PARTICLE_ALPHA_WORKAROUND(new MixinBuilder()
            .addClientMixins("minecraft.particleAlphaWorkaround.MixinEffectRenderer")
    ...
    VANILLA_XP_BAR_ALPHA_FIX(new MixinBuilder()
            .addClientMixins("minecraft.fixxpbaralpha.MixinGuiIngameForge")
    ...
    NTM_ARMORFIX(new MixinBuilder()
            .addClientMixins("ntm.armorfix.MixinModelBiped"
                    , "ntm.armorfix.MixinRenderBiped")
