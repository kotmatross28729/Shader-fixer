...
public class HFRWavefrontObjectShadowProxy implements IModelCustomNamed {
	...
	public HFRWavefrontObjectShadowProxy(String name) throws ModelFormatException {
		this(new ResourceLocation(RefStrings.MODID, name), false);
	}
	
	public HFRWavefrontObjectShadowProxy(String name, boolean mixedMode) throws ModelFormatException {
		this(new ResourceLocation(RefStrings.MODID, name), mixedMode);
	}
	
	public HFRWavefrontObjectShadowProxy noSmooth() {
	...
	public HFRWavefrontObjectShadowProxy(ResourceLocation resource, boolean mixedMode) throws ModelFormatException {
	...
	public HFRWavefrontObjectVBOShadowProxy asVBO() {
		return new HFRWavefrontObjectVBOShadowProxy(this);
	}
