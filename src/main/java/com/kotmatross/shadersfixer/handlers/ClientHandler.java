...
public class ClientHandler {
    ...
    public void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        // My
        if (Loader.isModLoaded("lightsabers")) {
            if (!Loader.instance()
                .getIndexedModList()
                .get("lightsabers")
                .getVersion()
                .contains("kotmatross edition")) {
                Lightsabers = false;
            }
        }
        ...
        if (Loader.isModLoaded("world-tooltips")) {
            if (!Loader.instance()
                .getIndexedModList()
                .get("world-tooltips")
                .getVersion()
        ...
        if (ShadersFixerLateMixins.oldAvaritia) {
            Avaritia = false;
        }

        ChatComponentText textSF = new ChatComponentText(
            EnumChatFormatting.RED + ""
                + EnumChatFormatting.BOLD
                + I18n.format("kotmatross.SF")
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ...
                            "https://github.com/kotmatross28729/Advanced_Lightsabers-Shaders_fix/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
            ...
            if (player.ticksExisted == ticks) {
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ClickEvent.Action.OPEN_URL,
                            "https://github.com/kotmatross28729/Neat-shaders-fix/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
            ...
            if (player.ticksExisted == ticks) {
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ClickEvent.Action.OPEN_URL,
                            "https://github.com/kotmatross28729/WorldTooltipsShadersFix/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
            ...
            if (player.ticksExisted == ticks) {
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ClickEvent.Action.OPEN_URL,
                            "https://github.com/kotmatross28729/Minechem-5-continuation/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
            ...
            if (player.ticksExisted == ticks) {
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ClickEvent.Action.OPEN_URL,
                            "https://github.com/kotmatross28729/ItemPhysic/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
            ...
            if (player.ticksExisted == ticks) {
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ClickEvent.Action.OPEN_URL,
                            "https://github.com/kotmatross28729/EnviroMine-continuation/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
            ...
            if (player.ticksExisted == ticks) {
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ClickEvent.Action.OPEN_URL,
                            "https://github.com/kotmatross28729/MatterMegadriveFork/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
            ...
            if (player.ticksExisted == ticks) {
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ClickEvent.Action.OPEN_URL,
                            "https://github.com/GTNewHorizons/Avaritia/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
            ...
            if (player.ticksExisted == ticks) {
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ClickEvent.Action.OPEN_URL,
                            "https://github.com/GTNewHorizons/NotEnoughItems/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
            ...
            if (player.ticksExisted == ticks) {
                ...
                textfork.getChatStyle()
                    .setChatClickEvent(
                        new ClickEvent(
                            ClickEvent.Action.OPEN_URL,
                            "https://github.com/GTNewHorizons/CodeChickenCore/releases"));
                ChatComponentText text3 = (ChatComponentText) textSF.appendSibling(textdepr0)
                    .appendSibling(text)
                    .appendSibling(textdepr1)
                    .appendSibling(textfork);
        ...
        if ((!Lightsabers || !Neat
            ...
            if (player.ticksExisted == ticks) {
                ...
                ChatComponentText text4 = new ChatComponentText(
                    I18n.format("kotmatross.endMSG4M") + I18n.format("kotmatross.endMSG4C")
                ...
                String Config = Launch.minecraftHome + File.separator
                    + "config"
                    + File.separator
                    + Tags.MODID
                    + File.separator
                ...
                text4.getChatStyle()
                    ...
                    .setBold(true)
                    .setChatClickEvent(new ClickEvent(ClickEvent.Action.OPEN_FILE, Config));

                // omagad
                ChatComponentText textFinal = (ChatComponentText) text0.appendSibling(text1)
                    .appendSibling(text2)
                    .appendSibling(text3)
                    .appendSibling(text4)
                    .appendSibling(text5);
