...
public class Utils {
     ...
     *    @Unique public static float shaders_fixer$lby;
     *
     *    @Inject(method = "METHOD_NAME", at = @At(value = "INVOKE", target = "L...", ordinal = 0, shift = BEFORE), remap = false)
     ...
     *    }
     *
     *    @Inject(method = "METHOD_NAME", at = @At(value = "INVOKE", target = "L...", ordinal = 0, shift = AFTER), remap = false)
     ...
     *
     *    @Inject(method = "METHOD_NAME", at = @At(value = "INVOKE", target = "L...;useShader()V", ordinal = 0, shift = BEFORE), remap = false)
     *    private void beforeUseShader(PARAMS, CallbackInfo ci) {
     *        shaders_fixer$program = Utils.GetGLCurrentProgram();
     *    }
     *    @Inject(method = "METHOD_NAME", at = @At(value = "INVOKE", target = "L...;releaseShader()V", ordinal = 0, shift = AFTER), remap = false)
