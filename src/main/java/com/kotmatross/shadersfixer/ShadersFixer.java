    ...
    public static void preInit(FMLPreInitializationEvent event) {
            ...
            if (Loader.isModLoaded("rivalrebels")) {
                if (!Loader.instance()
                    ...
                    throw new RuntimeException(
                        "You are using a version of Rival Rebels that is not compatible with ShadersFixer, please update to: https://github.com/kotmatross28729/Rival-Rebels-Mod/releases");
                }
            }
        }
        ...
        if (ShaderFixerConfig.optifineNTMSpaceCrash) {
            if (FMLCommonHandler.instance()
                .getSide() == Side.CLIENT) {
                if (ShadersFixerLateMixins.specjork && FMLClientHandler.instance()
                    .hasOptifine()) {
