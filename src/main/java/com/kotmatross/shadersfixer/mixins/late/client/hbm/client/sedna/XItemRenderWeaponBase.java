...
//Just ItemRenderWeaponBase class with marks, not used btw
public abstract class XItemRenderWeaponBase implements IItemRenderer {
    ...
    protected static float getSwayMagnitude(ItemStack stack) {
        return 0.5F;
    }
    protected static float getSwayPeriod(ItemStack stack) { return 0.75F;
    }
    protected static float getTurnMagnitude(ItemStack stack) { return 2.75F;
    }
